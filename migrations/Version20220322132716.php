 ...
 */
final class Version20220322132716 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE birthday birthday DATE NOT NULL, CHANGE register_at register_at DATETIME NOT NULL');
    }
